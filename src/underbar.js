(function() {
  ...
  _.identity = function(val) {
    return val; //return whatever is passed
  };
  ...
  _.reject = function(collection, test) {
    //create a new function which returns the opposite boolean values from the test function:
    var rejector = function(item){return !test(item);};
    return _.filter(collection, rejector);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    if (Array.isArray(collection)){
      ...
      var firstElementIndex = Object.keys(collection)[0];
      if (accumulator === undefined){
        accumulator = collection[firstElementIndex];
      }
      else{
        accumulator = iterator(accumulator, collection[firstElementIndex]);
      }
      delete collection[firstElementIndex];
  ...
  _.shuffle = function(array) {
    ...
    while (arrayCopy.length > 0){
      ...
      returnArray.push(arrayCopy.splice(randomIndex,1)[0]);
    }
    return returnArray;
  };
